    ...
    try:
        ...
        for i in range(paper_nums):
            ...
            if web.find_element(By.XPATH,checkbox_xpath).is_selected(): # 选中文献时
                ...
                order=paper_order+50*(current_page-1) # 结果总数中的第几篇文献
                print(f'第{current_page}页第{paper_order}篇·总第{order}篇：{title}')
                SaveToZotero()
